    ...
    <div className="p-4 space-y-6 pb-20">
      ...
      <div className="bg-[#0a0a0a] border border-[#1a1a1a] rounded-2xl p-6 text-center">
        <div className="w-20 h-20 rounded-full mx-auto mb-3 border-2 border-[#00ff41] bg-[#1a1a1a] flex items-center justify-center overflow-hidden">
          {userContext?.user?.pfpUrl ? <img src={userContext.user.pfpUrl} className="w-full h-full object-cover" /> : <span className="text-3xl text-gray-600 font-bold">?</span>}
        </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        {[
          ...
          <Button key={item.label} variant="outline" className="bg-[#0a0a0a] border-[#1a1a1a] h-16 flex flex-col gap-1 hover:border-[#00ff41]/50 text-white font-bold">
        ...
        <div className="space-y-3">
          <div className="bg-[#0a0a0a] border border-[#1a1a1a] p-4 rounded-xl flex justify-between items-center shadow-sm">
            <div>
              ...
              <p className="text-[10px] text-gray-500">Push your token to the top of the feed</p>
            </div>
            <Button size="sm" className="bg-[#00ff41] text-black font-black h-8 text-[10px] px-4 uppercase">$3 USDT</Button>
          </div>
          <div className="bg-[#0a0a0a] border border-[#1a1a1a] p-4 rounded-xl flex justify-between items-center shadow-sm">
            <div>
              <p className="font-bold text-sm">1 Hour Boost</p>
              <p className="text-[10px] text-gray-500">Extended visibility for your token</p>
            </div>
            <Button size="sm" className="bg-[#00ff41] text-black font-black h-8 text-[10px] px-4 uppercase">$5 USDT</Button>
          </div>
        </div>
      ...
      {/* Subscription Card */}
      <div className="bg-gradient-to-br from-[#111] to-[#050505] border border-[#00ff41]/20 p-5 rounded-2xl relative overflow-hidden shadow-2xl">
        <div className="absolute top-0 right-0 p-3 opacity-5"><ShieldCheck className="w-24 h-24 text-[#00ff41]" /></div>
        <h3 className="text-[#00ff41] font-black text-lg uppercase tracking-tighter">Premium Subscription</h3>
        <p className="text-xl font-bold mb-3 tracking-tight">$9 <span className="text-[10px] text-gray-500 uppercase font-normal">USDT / Month</span></p>
        ...
        <Button className="w-full mt-4 bg-[#00ff41] text-black font-black uppercase text-xs h-12 shadow-[0_0_20px_rgba(0,255,65,0.4)]">Subscribe Now</Button>
      </div>
