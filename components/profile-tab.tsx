  ...
  return (
    <div className="p-4 space-y-6 pb-20">
      ...
      <div className="space-y-3">
        <h3 className="text-[10px] font-black uppercase text-gray-500 flex items-center gap-2 tracking-widest"><Zap className="w-3 h-3 text-yellow-400" /> Boost Options</h3>
        ...
        <p className="text-[9px] text-center text-gray-600 font-mono uppercase tracking-tighter">Payments to: 0x1909b332397144aeb4867B7274a05Dbb25bD1Fec</p>
      </div>
      ...
      <div className="bg-gradient-to-br from-[#111] to-[#050505] border border-[#00ff41]/20 p-5 rounded-2xl relative overflow-hidden">
        ...
        <p className="text-xl font-bold mb-3">$9 <span className="text-[10px] text-gray-500 uppercase font-normal font-sans">USDT / Month</span></p>
